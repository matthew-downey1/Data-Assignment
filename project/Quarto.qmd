...
<div style="display: flex; align-items: center;">
  <img src="IMF.png" alt="IMF" style="margin-right: 10px;">
  <ul style="margin: 0;">
    <li>This organization helped effectively bail out countries like Ireland, Cyprus, and Portugal after the global financial crisis which helped rebuild these economies into the flourishing economies we see today!</li>
  </ul>
</div>
